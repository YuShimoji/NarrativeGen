...
|---------|--------|--------|------|-----------|
| **AI 機能拡張** | 生成履歴 | 中 | AI 生成の履歴管理と再利用 | Phase 3 |
| | プロンプトテンプレート | 低 | カスタマイズ可能なプロンプト設定 | Phase 4 |
| **Unity 統合** | UPM パッケージ | - | Unity Package Manager 対応 | 実装済み |
