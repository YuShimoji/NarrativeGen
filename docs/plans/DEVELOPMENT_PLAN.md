...
2. **Procedural-narrative policy frontier**
   ...
   - The G2 TS/Web slice now has local schema, engine, inference, cache, probe, Dashboard, Story-boundary, three-browser, build, and safety evidence. Lifecycle remains `partial` only until commit-associated CI closes.
